...
public class KLineChartView extends BaseKLineChartView {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if (array != null) {
            try {
                ...
                setMTextColor(array.getColor(R.styleable.KLineChartView_kc_text_color, getColor(R.color.chart_max_min)));
                ...
                setSelectedXLineColor(R.color.chart_selected_x);
                setSelectedXLineWidth(getDimension(R.dimen.chart_line_width));

                setSelectedYLineColor(R.color.chart_selected_y);
                setSelectedYLineWidth(getDimension(R.dimen.chart_select_y_width));
                ...
                setSelector2TextSize(array.getDimension(R.styleable.KLineChartView_kc_selector_text_size, getDimension(R.dimen.chart_selector_text_size)));
    ...
    public void setSelector2TextSize(float textSize) {
        mMainDraw.setSelector2TextSize(textSize);
    }
    ...
    public void setTextColor(int color) {
        ...
        mMainDraw.setSelectorTextColor(getResources().getColor(R.color.chart_selector_par1));
    }
