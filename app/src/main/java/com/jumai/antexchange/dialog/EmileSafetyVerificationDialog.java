 ...
 * 描述：安全验证
 */
public class EmileSafetyVerificationDialog extends BottomSheetDialog {
    ...
    public EmileSafetyVerificationDialog(@NonNull Context context,String mPhone,String mEmile,VertificationSuccessCallBack mVertificationSuccessCallBack) {
    ...
    private EmileSafetyVerificationDialog(@NonNull Context context, int theme) {
        super(context, theme);
    }
