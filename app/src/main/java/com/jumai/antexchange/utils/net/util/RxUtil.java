...
public class RxUtil {
     ...
     * IBaseView
     */
    public static <T> ObservableTransformer<T, T> lifecycle(IBaseView baseView) {
        return observable -> observable.compose(bindToLifecycle((LifecycleProvider) baseView));
    }
     ...
     * IBaseView
     */
    public static <T> ObservableTransformer<T, T> schedulersAndLifecycle(IBaseView baseView) {
        return observable -> observable.compose(bindToLifecycle((LifecycleProvider) baseView)).compose(io2main());
    }
