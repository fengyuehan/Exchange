...
public class VerificationCodeView extends LinearLayout implements TextWatcher, View.OnKeyListener, View.OnFocusChangeListener{
    ...
    private VerificationCodeView.OnCodeFinishListener onCodeFinishListener;
     ...
     * 输入框类型
     */
    private VerificationCodeView.VCInputType mEtInputType;
    /**
     * 输入框的宽度
     */
     ...
     * 字体样式
     */
    private VerificationCodeView.VCTextStyle mEtTextStyle;

    public VCTextStyle getmTextStyle() {
        return mEtTextStyle;
    }

    public void setmTextStyle(VCTextStyle mEtTextStyle) {
        this.mEtTextStyle = mEtTextStyle;
    }

    public VerificationCodeView.OnCodeFinishListener getOnCodeFinishListener() {
        return onCodeFinishListener;
    }

    public void setOnCodeFinishListener(VerificationCodeView.OnCodeFinishListener onCodeFinishListener) {
    ...
    public VerificationCodeView.VCInputType getmEtInputType() {
        return mEtInputType;
    }

    public void setmEtInputType(VerificationCodeView.VCInputType mEtInputType) {
    ...
    public VerificationCodeView(Context context, AttributeSet attrs) {
        ...
        int inputType = typedArray.getInt(R.styleable.vericationCodeView_vcv_et_inputType, VerificationCodeView.VCInputType.NUMBER.ordinal());
        mEtInputType = VerificationCodeView.VCInputType.values()[inputType];
        int textStyle = typedArray.getInt(R.styleable.vericationCodeView_vcv_et_textStyle, VCTextStyle.NORMAL.ordinal());
        mEtTextStyle = VerificationCodeView.VCTextStyle.values()[textStyle];
        ...
        mEtTextBg = typedArray.getResourceId(R.styleable.vericationCodeView_vcv_et_bg, R.drawable.et_box_code_bg);
