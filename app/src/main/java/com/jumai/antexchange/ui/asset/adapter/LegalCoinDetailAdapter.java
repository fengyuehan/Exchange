 ...
 * @Version 1.0
 */
public class LegalCoinDetailAdapter extends BaseQuickAdapter<CoinDetailBean, BaseViewHolder> {
    public LegalCoinDetailAdapter(@Nullable List<CoinDetailBean> data) {
