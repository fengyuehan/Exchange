...
/**
 * @ClassName HistoryRecordItemAdapter
 * @Description TODO
 * @Author user
 * @Date 2019/9/24
 * @Version 1.0
 */
public class HistoryRecordItemAdapter extends BaseQuickAdapter<CoinUnitBean, BaseViewHolder> {
    public HistoryRecordItemAdapter(@Nullable List<CoinUnitBean> data) {
